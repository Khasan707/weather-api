...
import by.bsuir.weather.api.CityService;
import by.bsuir.weather.api.WeatherService;
import by.bsuir.weather.api.OpenWeatherMapApi;
import by.bsuir.weather.pojo.city.CityInfoResponse;
...
public class MainActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder.setMessage(R.string.instruction_message).setTitle(R.string.instruction);
                    ...
                    public void onResponse(Call<CurrentWeather> call,
                        ...
                        try {
                            ...
                            Toast.makeText(getApplicationContext(),
                                    "Не найдена информация о погоде",
                                    Toast.LENGTH_SHORT
                            ).show();
