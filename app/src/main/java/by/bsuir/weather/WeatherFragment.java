...
import by.bsuir.weather.R;
import by.bsuir.weather.WeatherViewModel;
...
public class WeatherFragment extends Fragment {
    ...
    private TextView tvCurrentWindDirection;
    ...
    private void initialViews(View rootView) {
        ...
        tvCurrentPressure = rootView
                .findViewById(R.id.tv_current_pressure);
        tvCurrentWindSpeed = rootView.findViewById(R.id.tv_current_wind_speed);
        tvCurrentWindDirection = rootView.findViewById(R.id.tv_current_wind_direction);
    ...
    private void subscribeToModel() {
        model.getWeatherData().observe(this, currentWeatherDto ->  {
            ...
            tvCurrentPressure.setText(currentWeatherDto.getPressure() + " гПа");
            tvCurrentWindSpeed.setText(currentWeatherDto.getWindSpeed() + " м/с");
            tvCurrentWindDirection.setText(currentWeatherDto.getWindDirection() + "");
        });
    }
